<div class="col-md-6">
    <div class="card">
        <div class="card-body ">
            ...
            <?php endif; ?>	
            <?php echo form_open('profile/update/'.$get_item->user_id, 'class="mt-5 mb-5 login-input"'); ?>
                ...
                <div class="form-group">
                    <input type="password" name="password" class="form-control" value="<?php echo $get_item->user_password; ?>" required>
                </div>
