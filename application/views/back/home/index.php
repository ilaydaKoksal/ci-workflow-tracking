                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo count($this->all->get_all('records', array('record_stage' => $stage->stage_id))); ?></h2>
                    ...
                    <?php foreach($get_announcement as $anno): ?>
                        ...
                        <?php if($calc->invert != 1 && $calc->days < 6): ?>
                            <div class="alert alert-primary"><i class="fas fa-bomb"></i>
                                <?php echo '<b>'.$anno->user_name_surname.'</b>'.' adlı kullanıcının '.'<b>'.$anno->record_name_surname.'</b>'.' adlı müşterisi ile olan '.'<b>'.$anno->stage_name.'</b>'.' aşamasındaki '.'<b>'.$anno->status_name.'</b>'.' durumundaki görevine '.'<b>'.timespan($now, $post_date, 5).'</b>'.' kaldı!.'; ?>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
